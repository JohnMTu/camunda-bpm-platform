...
public class SetTaskPropertyAuthorizationTest extends AuthorizationTest {
  ...
  public static List<Object[]> data() {
    ...
    return Arrays.asList(new Object[][] {
        ...
        { ProcessEngineConfiguration.AUTHORIZATION_CHECK_REVOKE_ALWAYS, "setDueDate", setDueDate, "taskId",  DateTime.now().toDate()},
        { ProcessEngineConfiguration.AUTHORIZATION_CHECK_REVOKE_ALWAYS, "setFollowUpDate", setFollowUpDate, "taskId", DateTime.now().toDate() },
        ...
        { ProcessEngineConfiguration.AUTHORIZATION_CHECK_REVOKE_AUTO, "setDueDate", setDueDate, "taskId",  DateTime.now().toDate()},
        { ProcessEngineConfiguration.AUTHORIZATION_CHECK_REVOKE_AUTO, "setFollowUpDate", setFollowUpDate, "taskId", DateTime.now().toDate() }
    });
  }
